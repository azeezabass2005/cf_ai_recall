...
class GeofenceMonitorService : Service() {
    ...
    private fun checkProximity(location: Location) {
        val prefs = getSharedPreferences("ranti_geofence_prefs", MODE_PRIVATE)
    ...
    private fun ensureChannel() {
        ...
        val channel = NotificationChannel(
            ...
            description = "Shows while Ranti monitors location reminders"
            setShowBadge(false)
        }
    ...
    companion object {
        ...
        private const val CHANNEL_ID = "ranti_geofence_monitor"
        private const val NOTIF_ID = 9001
        const val ACTION_STOP = "com.ranti.action.STOP_GEOFENCE_MONITOR"
