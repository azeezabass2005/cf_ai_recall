...
Most reminder apps assume you'll remember to open them. Recall doesn't.

Recall is a voice-first reminder assistant that lives in the background of your phone. You talk to it the same way you'd talk to a person — no rigid commands, no specific syntax. You just say what you need, and Recall figures out the rest. It understands time, it understands place, and it asks when it doesn't.

Voice is the *primary* way in, but it isn't the *only* way in. Recall is also a real app you can open. When you can't speak — in a lecture, on a bus, in a meeting — you type. When you need to set up something that recurs every week, or browse what you already have, or tweak a reminder you set yesterday, you open the app and use it like any other app. Voice collapses the gap between thought and action; the app is for everything that needs more than a sentence.
...
**As a user**, I want to trigger Recall without touching my phone, so that I can set reminders the moment I think of them — even mid-task.
...
Recall responds and pops up — even though the app wasn't open.

She says: *"Remind me to submit the GEG assignment before 11pm"*

Recall confirms: *"Got it. I'll remind you at 10:45pm so you have time."*
...
He says: *"Hi Recall, remind me to give Sade her book when I reach Faculty of Technology Lecture Theatre"*

Recall looks up the location, finds it, sets a geofence, and confirms: *"Done. I'll remind you once you're within 100 metres of Faculty of Technology Lecture Theatre."*

Later, when Femi walks into the area — his phone buzzes: *"Give Sade her book."*

**Acceptance criteria:**
- Recall resolves place names via Google Places API
...
**As a user**, I want Recall to handle ambiguous location names gracefully instead of silently picking the wrong place or failing.

**Scenario:**
Amaka says: *"Remind me to buy data when I get to the plaza"*

Recall finds three places matching "plaza" nearby.

If two of them are within 50 metres of each other, Recall picks the more prominent one and confirms which it chose.

If they're spread across different areas, Recall asks: *"I found a few places that could match — University Shopping Plaza, Bola Plaza on Ile-Ife Road, or OAU Main Gate Plaza. Which one did you mean?"*

Amaka says: *"The one on Ile-Ife Road"*

Recall sets the reminder.
...
- Recall confirms the final choice before saving
...
**Scenario:**
Recall asks: *"Where is your hostel?"*

Kemi says: *"Adekunle Fajuyi Hall of Residence"*

Recall saves this. Next time Kemi says "my hostel", Recall knows exactly where she means.

**Acceptance criteria:**
- Recall detects when a place reference is ambiguous or personal ("my hostel", "my department", "home")
...
*"Hi Recall, remind me to check the pot in 15 minutes"*

Recall: *"Sure, I'll remind you at 3:42pm."*
...
Recall: *"Okay, reminder set for 7pm — Call your mum."*

**Acceptance criteria:**
- Recall understands relative time ("in 20 minutes", "in an hour") and absolute time ("at 6pm", "by 9am")
...
**Scenario A — voice:**
Halima has a class every Tuesday at 7pm. She says: *"Hi Recall, every Tuesday remind me about my class at 6:50pm"*

Recall confirms: *"Got it. Every Tuesday at 6:50 PM — your class. I'll keep reminding you each week until you tell me to stop."*
...
Halima opens Recall and taps the "+" button to create a reminder manually. A form appears: she types "Class", picks "Time", picks "Repeats weekly", taps "Tuesday", sets the time to 6:50 PM, and saves.

**Scenario C — managing recurrence:**
At the end of the semester, Halima says: *"Cancel my Tuesday class reminder"* — and Recall stops the recurrence entirely.

**Acceptance criteria:**
- Recall understands recurrence patterns: "every day", "every Tuesday", "every weekday", "every week", "every month on the 1st", "every morning at 8"
...
**Scenario:**
Bisi wants to set a reminder for her dentist appointment in three weeks at 2:30 PM at a specific clinic she's never been to. She opens Recall, taps "+ New Reminder", picks "Time", selects the date from a calendar, picks the time, types the body ("Dentist appointment"), and optionally adds a location by searching for the clinic — saves.
...
She says: *"Hi Recall, cancel the Shoprite reminder"*
...
- How does Recall behave when two reminders have the same or overlapping triggers?
